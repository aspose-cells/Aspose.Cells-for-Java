...
import static com.aspose.cells.maven.utils.AsposeMavenProjectManager.getAsposeProjectMavenDependencies;
import com.aspose.cells.maven.utils.AsposeCellsJavaAPI;
import com.aspose.cells.maven.utils.TasksExecutor;
...
@TemplateRegistration(
        ...
        description = "AsposeCellsMavenDescription.html",
        iconBase = "com/aspose/cells/maven/Aspose.png",
        position = 1,
        content = "AsposeMavenProject.zip")
@Messages("Aspose_displayName=Aspose.Cells Maven Project")
                ...
                if (entry.isDirectory()) {
                    ...
                    if (AsposeConstants.MAVEN_POM_XML.equals(entry.getName())) {
                        /*
                         ...
                         2. Adding latest Aspose.Cells Maven Dependency reference into pom.xml
                         */
