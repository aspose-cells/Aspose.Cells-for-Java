package featurescomparison.workingwithtables.pivottable.java;
...
public class ApacheCreatePivotTable
{
	...
	{
		String dataPath = "src/featurescomparison/workingwithtables/pivottable/data/";
        ...
        FileOutputStream fileOut = new FileOutputStream(dataPath + "ApachePivotTable.xlsx");
        wb.write(fileOut);
        fileOut.close();
        wb.close();
