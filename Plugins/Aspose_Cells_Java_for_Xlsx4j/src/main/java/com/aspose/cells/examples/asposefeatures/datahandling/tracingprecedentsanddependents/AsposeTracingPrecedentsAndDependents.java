package com.aspose.cells.examples.asposefeatures.datahandling.tracingprecedentsanddependents;
...
public class AsposeTracingPrecedentsAndDependents
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = Utils.getDataDir(AsposeTracingPrecedentsAndDependents.class);
