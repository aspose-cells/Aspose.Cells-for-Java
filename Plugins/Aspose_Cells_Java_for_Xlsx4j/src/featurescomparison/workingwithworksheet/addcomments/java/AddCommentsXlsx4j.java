...
public class AddCommentsXlsx4j
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			String outputfilepath = dataPath + "AddComments-Xlsx4j.xlsx";

			SpreadsheetMLPackage pkg = SpreadsheetMLPackage.createPackage();

			WorksheetPart sheet = pkg.createWorksheetPart(new PartName(
	...
	private static void addContent(WorksheetPart sheet) throws JAXBException,
			Docx4JException
	{
		...
		CTLegacyDrawing legacyDrawing = Context.getsmlObjectFactory()
				.createCTLegacyDrawing();
	...
	private static Cell createCell(String content)
	{
		...
		CTXstringWhitespace ctx = Context.getsmlObjectFactory()
	...
	public static CTComments createComment(String cell) throws JAXBException
	{
		...
		CTComments comments = (CTComments) XmlUtils.unwrap(XmlUtils
				.unmarshalString(openXML, Context.jcSML));
		return comments;
	}

	public static org.docx4j.vml.root.Xml getVml(int row, int col)
