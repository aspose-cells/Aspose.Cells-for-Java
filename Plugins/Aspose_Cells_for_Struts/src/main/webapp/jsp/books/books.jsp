...
<p>
	<h2>
		<img src="images/aspose-struts-logo.jpg"
			alt="Aspose.Cells for Java"> Aspose.Cells Struts Example -
		...
		<table>
			...
			<tr>
				...
				<td align="right"><input type="submit" class="imgClass"
					name="actionMethod" id="exportcells" value="ExportToExcel"
					disabled="true" /></td>
			</tr>
		</table>
	</form>
	...
	<script>
		...
		function enableEditDelete() {
			...
			document.getElementById('exportcells').disabled = false;
		}
	</script>
</body>
</html>