...
package programmersguide.asposecells.workingwithfiles.filehandlingfeatures.openingfiles.java;
...
public class OpeningFiles
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithfiles/filehandlingfeatures/openingfiles/data/";
