...
package programmersguide.asposecells.workingwithdata.addonfeatures.namedranges.mergecellsinnamedrange.java;
...
public class MergeCellsInNamedRange
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithdata/addonfeatures/namedranges/mergecellsinnamedrange/data/";
