...
package programmersguide.asposecells.workingwithdata.addonfeatures.namedranges.renamenamedrange.java;
...
public class RenameNamedRange
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithdata/addonfeatures/namedranges/renamenamedrange/data/";
