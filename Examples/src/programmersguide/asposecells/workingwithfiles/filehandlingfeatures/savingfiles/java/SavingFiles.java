...
package programmersguide.asposecells.workingwithfiles.filehandlingfeatures.savingfiles.java;
...
public class SavingFiles
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithfiles/filehandlingfeatures/savingfiles/data/";
