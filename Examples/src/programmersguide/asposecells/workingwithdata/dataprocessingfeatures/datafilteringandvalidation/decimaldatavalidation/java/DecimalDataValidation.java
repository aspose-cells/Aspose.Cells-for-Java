...
package programmersguide.asposecells.workingwithdata.dataprocessingfeatures.datafilteringandvalidation.decimaldatavalidation.java;
...
public class DecimalDataValidation
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithdata/dataprocessingfeatures/datafilteringandvalidation/decimaldatavalidation/data/";
