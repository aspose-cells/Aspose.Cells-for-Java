...
package programmersguide.asposecells.workingwithdata.dataprocessingfeatures.datafilteringandvalidation.timedatavalidation.java;
...
public class TimeDataValidation
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithdata/dataprocessingfeatures/datafilteringandvalidation/timedatavalidation/data/";
