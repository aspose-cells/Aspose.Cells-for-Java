...
package programmersguide.asposecells.workingwithdata.dataprocessingfeatures.datafilteringandvalidation.listdatavalidation.java;
...
public class ListDataValidation
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithdata/dataprocessingfeatures/datafilteringandvalidation/listdatavalidation/data/";
