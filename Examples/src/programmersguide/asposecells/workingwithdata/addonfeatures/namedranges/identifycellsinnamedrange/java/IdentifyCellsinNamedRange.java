...
package programmersguide.asposecells.workingwithdata.addonfeatures.namedranges.identifycellsinnamedrange.java;
...
public class IdentifyCellsinNamedRange
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/asposecells/workingwithdata/addonfeatures/namedranges/identifycellsinnamedrange/data/";
