...
public class SettingImagePrefrencesforHTML {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * HtmlSaveOptions(FileFormatType.HTML); saveOptions.getImageOptions()
		 * 
		 * //Set the ImageFormat to PNG saveOptions.ImageFormat =
		 * System.Drawing.Imaging.ImageFormat.Jpeg;
		 * 
		 * //Set SmoothingMode to AntiAlias
		 * saveOptions.ImageOptions.SmoothingMode =
		 * System.Drawing.Drawing2D.SmoothingMode.AntiAlias;
		 * 
		 * //Set TextRenderingHint to AntiAlias
		 * saveOptions.ImageOptions.TextRenderingHint =
