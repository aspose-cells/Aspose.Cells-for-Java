...
function FontOk()
{
	...
	acell.styleStr += txtSize.value + "|" + chkUnderline.checked + "|"
		+ chkStrike.checked + "|" + btnFC.style.backgroundColor + "|" + btnBG.style.backgroundColor
...
function setBorders()
{
	var bstr = borderWidth.options[borderWidth.selectedIndex].text + " " + borderStyle.options[borderStyle.selectedIndex].text + " " + btnBorderColor.style.backgroundColor;
	if (olist == null)
	{
		switch (setborder)
		{
