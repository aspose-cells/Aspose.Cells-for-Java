...
<body>
	<div>
		<p>
            This demo loads  a file with controls :scrollbar ,radiobutton,already supported
            checkbox listbox,combobox will be supported soon .
        </p>
	</div>
	...
	<div>
		<table>
			<tr>
				<th>Reload Data:</th>
				<td><input id="loadControls" type="button" value="Reload" onClick="doClick(this);"></td>
			</tr>
		</table>
	</div>
