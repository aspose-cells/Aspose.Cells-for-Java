...
//			out.close();
	...
	protected void reloadfileact(GridWebBean gridweb,HttpServletRequest request, String file,String pass) {
...
//			gridweb.importExcelFile(path + "file\\" + file);
			...
			if(pass!=null)
			{
			gridweb.importExcelFile(in,pass);	
			}else {
	...
	protected void reloadfile(GridWebBean gridweb,HttpServletRequest request, String file ) {
		...
		reloadfileact(gridweb,request,file,null);
