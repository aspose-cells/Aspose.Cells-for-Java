...
<body>
	<div>
		<p>
           This demo use CellModifiedOnAjax event to show a case.
           When user enter value in column B,same value will put in column C.
        </p>
	</div>
	...
	<div>
		<table>
			<tr>
				<th>Reload Data:</th>
				<td><input id="cellmodifyajax" type="button" value="Reload" onClick="doClick(this);"></td>
			</tr>
		</table>
	</div>
